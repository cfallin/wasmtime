...
mod test {
    ...
    fn test_compile_function() {
        ...
        // ret
        let golden = vec![
            0xfd, 0x7b, 0xbf, 0xa9, 0xfd, 0x03, 0x00, 0x91, 0x85, 0x46, 0x82, 0xd2, 0x00, 0x00,
            0x05, 0x0b, 0xfd, 0x7b, 0xc1, 0xa8, 0xc0, 0x03, 0x5f, 0xd6,
        ];
    ...
    fn test_branch_lowering() {
        ...
        // ret
        let golden = vec![
            253, 123, 191, 169, 253, 3, 0, 145, 132, 70, 130, 210, 4, 0, 4, 11, 229, 3, 4, 42, 165,
            0, 0, 181, 128, 70, 130, 210, 131, 0, 0, 11, 225, 3, 3, 42, 161, 255, 255, 181, 229, 3,
            4, 42, 101, 255, 255, 181, 134, 70, 130, 210, 128, 0, 6, 75, 253, 123, 193, 168, 192,
            3, 95, 214,
        ];
