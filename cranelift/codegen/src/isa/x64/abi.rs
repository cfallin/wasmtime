...
const WINDOWS_CLOBBERS: PRegMask = windows_clobbers();
const SYSV_CLOBBERS: PRegMask = sysv_clobbers();

const fn windows_clobbers() -> PRegMask {
    PRegMask::empty()
...
const fn sysv_clobbers() -> PRegMask {
    PRegMask::empty()
        .with(regs::gpr_preg(regs::ENC_RAX))
        .with(regs::gpr_preg(regs::ENC_RCX))
        .with(regs::gpr_preg(regs::ENC_RDX))
