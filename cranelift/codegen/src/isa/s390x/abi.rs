...
use alloc::boxed::Box;
use alloc::vec::Vec;
use regalloc2::{PReg, PRegMask, VReg};
...
impl ABIMachineSpec for S390xMachineDeps {
    ...
    fn get_regs_clobbered_by_call(_call_conv_of_callee: isa::CallConv) -> PRegMask {
        CLOBBERS
    }
...
const CLOBBERS: PRegMask = clobbers();
