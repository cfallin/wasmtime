            ...
            &ast::Pattern::Term {
                ...
                let ty = match expected_ty {
                    ...
                    Some(expected_ty) => {
                        ...
                        if let Some(converter_term) = self.converters.get(&(ret_ty, expected_ty)) {
                            if self.terms[converter_term.index()].has_extractor() {
                                ...
                                let converter_term_ident = Ident(
                                    tyenv.syms[self.terms[converter_term.index()].name.index()]
                                        .clone(),
                                    pos,
                                );
                                let expanded_pattern = ast::Pattern::Term {
                                    ...
                                    pos,
                                    args: vec![ast::TermArgPattern::Pattern(pat.clone())],
                                };
