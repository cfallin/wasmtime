...
pub enum ControlStackFrame {
    ...
    Block {
        ...
        /// checkpoint to rewind to when we leave the block.
        try_table_checkpoint: Option<HandlerStateCheckpoint>,
    },
    Loop {
        destination: Block,
        header: Block,
...
impl ControlStackFrame {
    ...
    pub fn restore_catch_handlers(&self, handlers: &mut HandlerState) {
        match self {
            &ControlStackFrame::Block {
                try_table_checkpoint: Some(ckpt),
                ..
            } => {
