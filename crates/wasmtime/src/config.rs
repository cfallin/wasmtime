...
impl Config {
    ...
    /// Configure the use of VeriWasm, a static analyzer that checks heap
    /// isolation for machine code generated by the Wasm compiler.
    pub fn veriwasm(&mut self, enable: bool) -> &mut Self {
        self.veriwasm = enable;
        self
    }
    ...
    pub(crate) fn validate(&self) -> Result<()> {
        ...
        #[cfg(not(feature = "veriwasm"))]
        if self.veriwasm {
            bail!("VeriWasm support is not enabled in this build of Wasmtime");
        }
